...
fewshot.get_fewshot_message = function(filetype)
  return {
    messages = {
      {
        role = "system",
        content = [[
Identify any readability issues in this ]]
          .. filetype
          .. [[ code.
...
- Lack of comments when code is not self-explanatory
- Long or complex one liners
- Too much nesting
- Long variable names
- Inconsistent naming and code style.
- Code repetition
Identify any additional problems related to reability. Only list lines with readability issues, in the format line=<num>: <issue and proposed solution>
